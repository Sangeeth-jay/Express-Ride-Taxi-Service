<?php
    ...
    $sql = "UPDATE booking SET `acceptation` = 'not-accepted' WHERE (`booking_id` = '$bookingId');";
    $result = mysqli_query($conn, $sql);

    $sql2 = "INSERT INTO booking_status (`date`, `status`, `time`, `booking_booking_id`) VALUES ('$date', 'not-accepted', '$time', '$bookingId');    ";
